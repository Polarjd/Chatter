...
// Bot activity
client.on('ready', () => {
    console.log(`Logged in as ${client.user.tag}. Currently used in ${client.guilds.size} servers by ${client.guilds.cache.reduce((a, g) => a + g.memberCount, 0)} users`);
...
client.on('message', async message => {
    ...
    switch (args[0].toLowerCase()) {
        ...
        case "help":
            ...
            .addField('Join the support server', 'https://discord.gg/VX5wHn3cFX')
        ...
        case 'info':
            ...
            .addField('Chatterer was developed in 2020 by Polar66', '*If you have any questions or want to report a bug contact me at Polar66#3425*')
            .setColor(0x85D7FA)
            .setTimestamp()
            .setThumbnail('https://i.imgur.com/a8jqe4s.png')
            .setFooter('patreon.com/chatterbot', 'https://i.imgur.com/1EKSIoz.png')
